...
<head>
    ...
    <title>AI Call SYNC - Recuperar Contraseña</title>
    ...
    <style>
        ...
        .subtitle { color: var(--text-muted); font-size: 0.9rem; margin-bottom: 2rem; line-height: 1.5; }
        ...
        .success { color: #4ade80; font-size: 0.9rem; margin-bottom: 1.5rem; background: rgba(74,222,128,0.1); padding: 0.75rem 1rem; border-radius: 8px; }
...
<body>
    ...
    <div class="card">
        ...
        <form action="{{ route('password.email') }}" method="POST" onsubmit="handleSubmit(this)">
            @csrf
            <div class="form-group">
                <label>Correo Electrónico</label>
                <input type="email" name="email" value="{{ old('email') }}" required autofocus placeholder="admin@ejemplo.com">
            </div>
            <button type="submit" id="submitBtn" class="btn">Enviar enlace de recuperación</button>
        </form>
