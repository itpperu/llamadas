...
<body>
    ...
    <aside>
        ...
        <nav class="nav-links">
            <a href="{{ route('reports.index') }}" class="nav-item {{ request()->routeIs('reports.index') || request()->routeIs('reports.show') ? 'active' : '' }}">
                📊 Reportes
            </a>
            <a href="{{ route('reports.vendors') }}" class="nav-item {{ request()->routeIs('reports.vendors') ? 'active' : '' }}">
                📈 Resumen Vendedores
            </a>
